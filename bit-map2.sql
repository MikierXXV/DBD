...
CREATE bitmap INDEX seu ON departaments(seu) PCTFREE 0;

ALTER TABLE empleats MINIMIZE RECORDS_PER_BLOCK;
CREATE bitmap INDEX dpt ON empleats(dpt) PCTFREE 0;

CREATE INDEX edat ON empleats(edat,sou) PCTFREE 33;
